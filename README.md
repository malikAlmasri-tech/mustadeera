...
│
├── supabase/functions/ai/ ← 🤖 دالّة الحافّة: لوحات AI الثلاث (حلّت محلّ Code.gs)
...
│
├── _refs/                 ← 📦 **ليس منتَجًا** — لا يقرؤه كودٌ ولا بناء (اقرأ `_refs/README.md`)
...
│   └── replit-exports/    ← مشروعا Replit — مستثنى من git (حجمه)
│
...
## ⛔ حالة `_refs/legacy-backend/Code.gs` — ميّت، ويُحتفَظ به مرجعًا فقط
